...
do
    ...
    case $InputValue in
        1 )
            # call script create_db_mysql.sh
            echo -e "\n ***** Create databases using Mysql ***** \n"
            /home/don/workspace/books/books_scripts/z_db_create_mysql.sh
            ;;

        2 )
            # call script create_db.sh
            echo -e "\n ##### Create databases using Rake #####"
            /home/don/workspace/books/books_scripts/z_db_create_rake.sh
            ;;
...
# ----------------------------------------------------------------- #
# 04/18/2020 : 0.0.1  : Changed path location of scripts            #
