#!/bin/bash
#
# Start menu for create and deleta Databases Books.
...
do
    ...
    case $InputValue in
        1 )
            ...
            /home/don/workspace/books/books_scripts/z_menu_db_create.sh
            ;;
        ...
        2 )
            ...
            if [ $Answer == "Y" ]; then
                ...
                /home/don/workspace/books/books_scripts/z_db_delete_mysql.sh
            else
                echo -e ""
                echo -e "\t***************************"
        ...
        3 )
            ...
            /home/don/workspace/books/books_scripts/z_db_grant_mysql.sh
            ;;

        4 )
            # call script db_show_mysql.sh
            echo -e "\n ===== Show all databases using Mysql ====="
            /home/don/workspace/books/books_scripts/z_db_show_mysql.sh
            ;;

        5 )
            # call script menu_db_create.sh
            echo -e "\n ===== Call menu tb create ====="
            /home/don/workspace/books/books_scripts/z_menu_tb_create.sh
            ##echo "5 InputValue = $InputValue"
            ;;

        6 )
            # call script menu_tb_load.sh
            echo -e "\n ===== Call menu tb load ====="
            /home/don/workspace/books/books_scripts/z_menu_tb_load.sh
            ;;

        7 )
            # call script menu_tb_delete.sh
            echo -e "\n ===== Call menu tb delete ====="
            /home/don/workspace/books/books_scripts/z_menu_tb_delete.sh
            ;;

        8 )
            # call script tb_show_all_mysql.sh
            echo -e "\n ===== Show all tables using Mysql ====="
            /home/don/workspace/books/books_scripts/z_tb_show_all_mysql.sh
           ;;
...
# ----------------------------------------------------------------- #
# 04/09/2020 : 0.0.1  : Orginal - copyed from main.sh.              #
# ----------------------------------------------------------------- #
