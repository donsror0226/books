...
do
    ...
    case $InputValue in
        1 )
            ...
            _are_you_sure
            if [ $Answer = "Y" ]; then
                /home/don/workspace/books/books_scripts/z_tb_delete_books_mysql.sh 
            else
                _no_table_deleted
            fi
            ;;
        ...
        2 )
            ...
            _are_you_sure
            if [ $Answer = "Y" ]; then
                /home/don/workspace/books/books_scripts/z_tb_delete_conditions_mysql.sh
            else
                _no_table_deleted
            fi
            ;;
        ...
        3 )
            ...
            _are_you_sure
            if [ $Answer = "Y" ]; then
                /home/don/workspace/books/books_scripts/z_tb_delete_media_types_mysql.sh
            else
                _no_table_deleted
            fi
                ;;
        ...
        4 )
            ...
            _are_you_sure
            if [ $Answer = "Y" ]; then
                /home/don/workspace/books/books_scripts/z_tb_delete_purposes_mysql.sh
            else
                _no_table_deleted
            fi
            ;;
        ...
        8 )
            ...
            _are_you_sure
            if [ $Answer = "Y" ]; then
                /home/don/workspace/books/books_scripts/z_tb_delete_all_mysql.sh
            else
                _no_table_deleted
            fi
           ;;
...
# ----------------------------------------------------------------- #
# 04/14/2020 : 0.0.1  : Orginal - Copyed from z_menu_tb_create.sh.  #
# ----------------------------------------------------------------- #
# 04/15/2020 : 0.0.2  : Remove unneed comment lines.                #
